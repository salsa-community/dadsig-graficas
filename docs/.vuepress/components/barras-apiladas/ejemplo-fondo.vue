<template>
    <div>
        <DaiBarrasApiladas
            :barras_apiladas_id="'barras_basicas_fondo'" 
            :datos="datos"
...
export default {
  ...
  mounted(){
      this.modificandoFondo()
  },
  methods: {
    modificandoFondo(){
        this.$refs.barritas_fondo.grupo_fondo
            .append("rect")
            .attr("x", 0)
            .attr("y", this.$refs.barritas_fondo.escalaY(690))
            .attr("width", this.$refs.barritas_fondo.ancho)
            .attr("height", this.$refs.barritas_fondo.escalaY(400) - this.$refs.barritas_fondo.escalaY(690))
            .style("fill","blue")
            .style("fill-opacity", ".5")
        this.$refs.barritas_fondo.grupo_fondo
            .append("rect")
            .attr("x", 0)
            .attr("y", this.$refs.barritas_fondo.escalaY(400))
            .attr("width", this.$refs.barritas_fondo.ancho)
            .attr("height", this.$refs.barritas_fondo.escalaY(150) - this.$refs.barritas_fondo.escalaY(400))
            .style("fill","red")
        ...
        this.$refs.barritas_fondo.grupo_fondo
            .append("rect")
            .attr("x", 0)
            .attr("y", this.$refs.barritas_fondo.escalaY(150))
            .attr("width", this.$refs.barritas_fondo.ancho)
            .attr("height", this.$refs.barritas_fondo.escalaY(0) - this.$refs.barritas_fondo.escalaY(150))
            .style("fill","green")
            .style("fill-opacity", ".3")
